...
import { useIntroComplete } from "@/components/IntroContext";
...
export default function IntroCard() {
  ...
  return (
    <section className="px-6 pt-28 pb-4 max-w-5xl mx-auto w-full">
      <motion.div
        {...fadeUp(0)}
      ...
      >
        <div className="grid md:grid-cols-[auto_1fr] gap-6 md:gap-10 items-center">
          ...
          <div>
            <p className="font-mono text-highlight text-[11px] tracking-[0.2em] uppercase mb-2">
              {PERSONAL_INFO.university}&nbsp;·&nbsp;Computing Science&nbsp;·&nbsp;{PERSONAL_INFO.minor}
            </p>
            <h1
              className="font-grotesk font-bold text-text-primary leading-none mb-3"
              style={{ fontSize: "clamp(2rem, 5vw, 3.2rem)", letterSpacing: "-0.02em" }}
            >
              {PERSONAL_INFO.name}
            </h1>
            <p className="font-grotesk text-text-secondary text-sm mb-5 min-h-[1.4em]">
              <Typewriter text={TAGLINE} delay={300} />
            </p>
